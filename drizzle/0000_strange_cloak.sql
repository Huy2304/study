...
CREATE TABLE "player_stats" (
	...
	"total_play_seconds" bigint DEFAULT 0 NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL
);
--> statement-breakpoint
CREATE TABLE "todos" (
...
ALTER TABLE "game_runs" ADD CONSTRAINT "game_runs_user_id_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "game_runs_client_run_id_unique" ON "game_runs" USING btree ("client_run_id");--> statement-breakpoint
CREATE INDEX "game_runs_user_id_idx" ON "game_runs" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "game_runs_created_at_idx" ON "game_runs" USING btree ("created_at");--> statement-breakpoint
CREATE INDEX "notes_user_updated_idx" ON "notes" USING btree ("user_id","updated_at");--> statement-breakpoint
CREATE INDEX "player_stats_total_score_idx" ON "player_stats" USING btree ("total_score");--> statement-breakpoint
CREATE INDEX "todos_user_updated_idx" ON "todos" USING btree ("user_id","updated_at");